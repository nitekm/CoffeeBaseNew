...
enum class SortOptions(val iconRotateValue: Float, val nameResId: Int, val sortProperty: String, val sortDirection: String, val contentDescitpionResId: Int) {
    ...
    SCA_SCORE_ASC(90f, R.string.sca_score, "scaScore", "ASC", R.string.sort_sca_score_asc),
    SCA_SCORE_DESC(270f, R.string.sca_score, "scaScore", "DESC", R.string.sort_sca_score_desc)
}